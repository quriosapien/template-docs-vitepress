...
> `2.0.0-alpha.19`) — a deliberate exception to this template family's
...
> (via `2.0.0-alpha.19`) and `npm audit` is clean. Re-checked during the
> 2026-08-30 weekly dependency pass — `2.0.0-alpha.19` is still the newest
